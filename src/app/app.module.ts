...
import { faHome, faAddressCard, faGraduationCap,
  faBook, faSuitcase, faNewspaper, faMapMarkedAlt, faPhoneAlt, faEnvelope, faAsterisk } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
  constructor(private library: FaIconLibrary) {
    ...
    library.addIcons(faUser, faGraduationCap, faAddressCard, faBook, faSuitcase, faNewspaper, faMapMarkedAlt,
      faPhoneAlt, faEnvelope, faHome, faStackOverflow, faGithub, faLinkedinIn, faTwitter, faMedium, faAsterisk, faBuilding);
  }
}
